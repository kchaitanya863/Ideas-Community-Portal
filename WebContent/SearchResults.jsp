...
if(ses.getAttribute("uname")==null)
 ...
 %>
<title><%=request.getParameter("search") %></title>
<%
...
<div class="container"> 
      ...
      <div class="collapse navbar-collapse" id="defaultNavbar1">
        ...
        <form class="navbar-form navbar-left" role="search" action="SearchServlet" method="post">
          <div class="form-group">
            <input type="text" class="form-control" placeholder="Search" name="search" value="<%=request.getParameter("search")%>">
          </div>
 ...
 int number = 0;
    try{
		...
		String sql = "select * from ideas2 where title LIKE '"+request.getParameter("search")+"' OR desc = '"+request.getParameter("search")+"' or postedby = '"+request.getParameter("search")+"' or postedon ='"+request.getParameter("search")+"'";
		//String sql = "select * from ideas2 WHERE title like 'Hello'";
	...
	catch(Exception e)
	{
    	...
    	if(number==0)
    	{
    		%>
    		 <center>
    		<p> Sorry no results found!! <a  href="javascript:history.back()">Go Back!!</a></p>
    		</center>
    		<%
    	}
    }
